...
import ToggleRoomPublicReducer from "./toggle_room_public_reducer";
...
const tablesSchema = __schema({
  ...
  room: __table({
    ...
    indexes: [
      ...
      { accessor: 'room_game_type', name: 'room_game_type_idx_btree', algorithm: 'btree', columns: [
        'gameType',
      ] },
  ...
  roomMember: __table({
    ...
    indexes: [
      ...
      { accessor: 'room_member_player', name: 'room_member_player_identity_idx_btree', algorithm: 'btree', columns: [
        'playerIdentity',
      ] },
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("toggle_room_public", ToggleRoomPublicReducer),
);
